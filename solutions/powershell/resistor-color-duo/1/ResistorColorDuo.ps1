Function Get-ColorCodeValue() {
    ...
    $ColorCodes = @{'black' = 0; 'brown' = 1; 'red' = 2; 'orange' = 3; 'yellow' = 4; 'green' = 5; 'blue' = 6; 'violet' = 7; 'grey' = 8; 'white' = 9};
    for($i = 0; $i -lt 2 -And $i -lt $Colors.Count; $i++){
        $result = [int]$result * 10 + $ColorCodes[$Colors[$i]]
    }
